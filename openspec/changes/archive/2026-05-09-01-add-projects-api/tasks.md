...
- [x] 2.1 Create `GI.Tracking` context module
- [x] 2.2 Create `GI.Tracking.Project` schema with changeset
...
- [x] 3.1 Create `GIWeb.Api.V1.Schemas.Project` module with request/response schemas

## 4. API Controller

- [x] 4.1 Create `GIWeb.Api.V1.ProjectController` with index, show, create, update, delete actions
...
- [x] 6.1 Write unit tests for `GI.Tracking.Project` schema
